...
```sh
cd my-folder
  git clone https://github.com/Tekhlay/OOP-school-library.git
```
...
Feel free to check the [issues page](https://github.com/Tekhlay/OOP-school-library/issues/).
...
This project is [MIT](https://github.com/Tekhlay/OOP-school-library/blob/dev/LICENSE) licensed.
